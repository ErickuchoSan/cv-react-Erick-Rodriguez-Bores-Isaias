...
- **Extensión de Jira + servidores MCP (Grupo Salinas)**: herramienta interna que se distribuye por zip; nunca decir que está en la Chrome Web Store. Sin claves de Jira ni números de ticket. Usuarios y tiempo ahorrado no están medidos: no inventarlos.
