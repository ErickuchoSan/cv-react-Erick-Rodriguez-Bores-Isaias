// ═══ v3 HERO: Shader backdrop + gigantic masked typography ═══════════════
  ...
  useEffect(() => {
    ...
    const fs = `
      ...
      void main(){
        ...
        float f = fbm(uv + r);
        vec3 base = u_base;
        vec3 col = mix(base, u_accent, smoothstep(0.2,0.9,f) * 0.35);
    ...
    const tick = () => {
      ...
      const [br,bg_,bb] = hex(bg.startsWith('#') ? bg : '#0a0a0a');
...
function HeroV3() {
  ...
  return (
    <section id="hero" data-screen-label="01 Hero" style={{
      ...
      {/* Subtle overlay — works in light + dark by using theme bg */}
      <div style={{
      ...
      <div style={{
        ...
        <Reveal duration={900}>
          <div style={{
            ...
            <span style={{ color: 'var(--fg)', opacity: 0.75, marginLeft: 6 }}>— portfolio / curriculum / 2026</span>
          </div>
        </Reveal>
        ...
        <h1 style={{
          ...
          <div>
            <MaskReveal delay={200}>Erick</MaskReveal>
          </div>
            ...
            <Parallax speed={0.05}>
              <Tilt max={8} glare>
                <div style={{
                  ...
                  {/* Corner ticks */}
                  {[[6,6,'tl'],[6,'',6,'tr'],['',6,6,'bl'],['','',6,'br']].map((c, i) => {
                    const [t, r, b, id] = [
                      i < 2 ? 8 : 'auto', i === 1 || i === 3 ? 8 : 'auto',
                      i >= 2 ? 8 : 'auto', i === 0 || i === 2 ? 8 : 'auto'
                    ];
                    return null;
                  })}
                </div>
          ...
          <Reveal delay={1000}>
            <div style={{
              ...
              <p style={{
                ...
                Desarrollador Full Stack con <em style={{ color: 'var(--accent)', fontWeight: 500 }}>{D.years} años</em> construyendo arquitecturas empresariales críticas. Actualmente en <em style={{ color: 'var(--accent)', fontWeight: 500 }}>Grupo Salinas</em>.
              </p>

              <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginTop: 28 }}>
                <Magnetic strength={0.25}>
                  <a href="#contact" data-cursor="escribir" style={{
                ...
                <Magnetic strength={0.2}>
                  <a href="#projects" data-cursor="ver" style={{
                    display: 'inline-flex', alignItems: 'center', gap: 10,
                    padding: '14px 24px',
                    background: 'var(--bg)',
                    color: 'var(--fg)',
      ...
      <style>{`
        ...
        @media (max-width: 1000px) {
          .hero-v3-grid { grid-template-columns: 1fr !important; gap: 30px !important; }
        }
      `}</style>
    </section>
  );
...
Object.assign(window, { HeroV3, ShaderBG, TerminalV3 });
