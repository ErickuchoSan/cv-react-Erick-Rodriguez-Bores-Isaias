...
export const WEB_SKILLS: Record<SkillCategory, readonly string[]> = {
  backend: [
    ...
    'Entity Framework', 'Dapper', 'CQRS / MediatR', 'Stored Procedures', 'REST API', 'Swagger',
...
export const ATS_SKILLS: readonly AtsSkill[] = [
  ...
  { name: 'React 19', months: 24 },
  { name: 'Next.js 16', months: 12 },
  ...
  { name: 'Dapper · MediatR (CQRS) · FluentValidation · Serilog', months: 3 },
  ...
  { name: 'xUnit · Moq · Testcontainers · Playwright + axe', months: 3 },
