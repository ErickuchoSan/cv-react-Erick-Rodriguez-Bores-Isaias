...
export type AccentKey = 'terracotta' | 'rust' | 'mustard' | 'lime' | 'cyan' | 'violet';

/** Labels are translated (`translations.accents`); values are the raw brand colors. */
export const ACCENT_OPTIONS: readonly { key: AccentKey; value: string }[] = [
  { key: 'terracotta', value: '#ff5b2e' },
  { key: 'rust', value: '#d14a24' },
  { key: 'mustard', value: '#eab308' },
  { key: 'lime', value: '#84cc16' },
  { key: 'cyan', value: '#22d3ee' },
  { key: 'violet', value: '#a78bfa' },
];
